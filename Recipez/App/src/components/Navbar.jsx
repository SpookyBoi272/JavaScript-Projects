  ...
  return (
    <header className='Nav-box h-20 border-borderColor border-2 rounded-full flex justify-between items-center box-border'>
      ...
      <div className="search-wrapper">
        ...
        <div className='w- h-10 bg-btnBg flex items-center justify-center rounded-lg mr-2 cursor-pointer'>
